...
# Add FlappyBird_environment directory to system path
# (Here: FlappyBird_agents is in the same directory as FlappyBird_environments)
parentdir = os.path.dirname(os.path.dirname(os.getcwd()))
sys.path.append(os.path.join(parentdir, 'FlappyBird_environment'))
