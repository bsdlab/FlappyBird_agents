...
def arg_parser():
    ...
    # Game instance: Naming convention is <game>-<non-stationarity>-nl<noise_level>-nrf<nrandfeat>-<phase>-v0
    # game = 'ContFlappyBird'
    # nonstationarity: 'gfNS', 'gsNS', 'rand_feat'
    # nrandfeat: '-nrf' + '', 0,2,3,4
    # Noiselevel: '-nl' +  '', 0.0001 - 0.05 (see envs/__init__.py)
    # experiment_phase: '-test', '-train'
    parser.add_argument('--env', help='environment ID', default='ContFlappyBird-v1')
    parser.add_argument('--test_env', help='testv environment ID', default='ContFlappyBird-v1')
