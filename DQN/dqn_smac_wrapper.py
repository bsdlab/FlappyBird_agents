...
def dqn_arg_parser():
    ...
    parser.add_argument('--units_layer1', help='Units in first hidden layer', type=int, default=24)
    parser.add_argument('--units_layer2', help='Units in second hidden layer', type=int, default=24)
    parser.add_argument('--units_layer3', help='Units in third hidden layer', type=int, default=24)
...
def dqn_smac_wrapper(**params):
    ...
    if params["architecture"] == 'lstm' or (params["architecture"] == 'gru'):
        ...
        # pa["batch_size"] = 5
        cs.add_hyperparameters([epsilon, epsilon_decay, activ_fcn, lr, tau, trace_length])
        ...
        cs.add_hyperparameters([epsilon, epsilon_decay, activ_fcn, lr, tau, batch_size])
